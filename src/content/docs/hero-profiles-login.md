---
title: Managing Heroes
slug: managing-heroes
sidebar_position: 3
description: Create and manage hero profiles, login PINs, linked child accounts, and star starting points.
---
...
## Recommended login setup by use case
...
For broader account and sign-in issues, see [Account, login, and onboarding](/docs/account-login-onboarding).
