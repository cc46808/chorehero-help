...
sidebar_position: 4
description: Configure chore options step by step, including assignment, schedule rules, proof requirements, and activation timing.
---
...
![Chores tab in Parent Dashboard before opening the chore setup flow](/img/help-guides/creating-chores-parent-tab.png?v=4)
