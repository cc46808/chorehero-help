...
sidebar_position: 5
description: Build a clear, motivating rewards catalog with practical guidance on cost, cooldowns, availability, and categories.
---
...
![Rewards tab in Parent Dashboard](/img/help-guides/setting-up-rewards-parent-tab.png?v=4)
